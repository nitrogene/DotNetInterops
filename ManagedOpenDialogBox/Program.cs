...
using static ManagedOpenDialogBox.FileDialogNative;
...
namespace ManagedOpenDialogBox
{
    ...
    public class Program
    {
        ...
        {
            // DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7 is the clsid of FileOpenDialog
            var clsid = new Guid("DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7");
            var type = Type.GetTypeFromCLSID(clsid, true);
            var instance = (IFileDialog)Activator.CreateInstance(type);

            // https://referencesource.microsoft.com/#System.Windows.Forms/winforms/Managed/System/WinForms/FileDialog.cs,1b77bc8b90a00a00
            instance.Show(new System.IntPtr(0));
